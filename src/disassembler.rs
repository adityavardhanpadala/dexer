...
pub fn get_decoder_map() -> BTreeMap<Opcode, OpcodeInfo> {
    ...
    map.insert(Opcode::MOVE_FROM16, ("move/from16", InstructionFormat::Format22x));
    map.insert(Opcode::MOVE_16, ("move/16", InstructionFormat::Format32x));
    map.insert(Opcode::MOVE_WIDE, ("move-wide", InstructionFormat::Format12x));
    map.insert(Opcode::MOVE_WIDE_FROM16, ("move-wide/from16", InstructionFormat::Format22x));
    map.insert(Opcode::MOVE_WIDE_16, ("move-wide/16", InstructionFormat::Format32x));
    map.insert(Opcode::MOVE_OBJECT, ("move-object", InstructionFormat::Format12x));
    map.insert(Opcode::MOVE_OBJECT_FROM16, ("move-object/from16", InstructionFormat::Format22x));
    map.insert(Opcode::MOVE_OBJECT_16, ("move-object/16", InstructionFormat::Format32x));
    map.insert(Opcode::MOVE_RESULT, ("move-result", InstructionFormat::Format11x));
    map.insert(Opcode::MOVE_RESULT_WIDE, ("move-result-wide", InstructionFormat::Format11x));
    map.insert(Opcode::MOVE_RESULT_OBJECT, ("move-result-object", InstructionFormat::Format11x));
    map.insert(Opcode::MOVE_EXCEPTION, ("move-exception", InstructionFormat::Format11x));
    
    // Return instructions
    map.insert(Opcode::RETURN_VOID, ("return-void", InstructionFormat::Format10x));
    map.insert(Opcode::RETURN, ("return", InstructionFormat::Format11x));
    map.insert(Opcode::RETURN_WIDE, ("return-wide", InstructionFormat::Format11x));
    map.insert(Opcode::RETURN_OBJECT, ("return-object", InstructionFormat::Format11x));
    ...
    map.insert(Opcode::CONST_HIGH16, ("const/high16", InstructionFormat::Format21h));
    map.insert(Opcode::CONST_WIDE_16, ("const-wide/16", InstructionFormat::Format21s));
    map.insert(Opcode::CONST_WIDE_32, ("const-wide/32", InstructionFormat::Format31i));
    map.insert(Opcode::CONST_WIDE, ("const-wide", InstructionFormat::Format51l));
    map.insert(Opcode::CONST_WIDE_HIGH16, ("const-wide/high16", InstructionFormat::Format21h));
    map.insert(Opcode::CONST_STRING, ("const-string", InstructionFormat::Format21c));
    map.insert(Opcode::CONST_STRING_JUMBO, ("const-string/jumbo", InstructionFormat::Format31c));
    map.insert(Opcode::CONST_CLASS, ("const-class", InstructionFormat::Format21c));
    
    // Monitor instructions
    map.insert(Opcode::MONITOR_ENTER, ("monitor-enter", InstructionFormat::Format11x));
    map.insert(Opcode::MONITOR_EXIT, ("monitor-exit", InstructionFormat::Format11x));
    
    // Type check and cast instructions
    map.insert(Opcode::CHECK_CAST, ("check-cast", InstructionFormat::Format21c));
    map.insert(Opcode::INSTANCE_OF, ("instance-of", InstructionFormat::Format22c));
    
    // Array instructions
    map.insert(Opcode::ARRAY_LENGTH, ("array-length", InstructionFormat::Format12x));
    map.insert(Opcode::NEW_ARRAY, ("new-array", InstructionFormat::Format22c));
    map.insert(Opcode::FILLED_NEW_ARRAY, ("filled-new-array", InstructionFormat::Format35c));
    map.insert(Opcode::FILLED_NEW_ARRAY_RANGE, ("filled-new-array/range", InstructionFormat::Format3rc));
    map.insert(Opcode::FILL_ARRAY_DATA, ("fill-array-data", InstructionFormat::Format31t));
    
    // Instance field instructions
    map.insert(Opcode::IGET, ("iget", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_WIDE, ("iget-wide", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_OBJECT, ("iget-object", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_BOOLEAN, ("iget-boolean", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_BYTE, ("iget-byte", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_CHAR, ("iget-char", InstructionFormat::Format22c));
    map.insert(Opcode::IGET_SHORT, ("iget-short", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT, ("iput", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_WIDE, ("iput-wide", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_OBJECT, ("iput-object", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_BOOLEAN, ("iput-boolean", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_BYTE, ("iput-byte", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_CHAR, ("iput-char", InstructionFormat::Format22c));
    map.insert(Opcode::IPUT_SHORT, ("iput-short", InstructionFormat::Format22c));
    
    // Method invoke instructions
    map.insert(Opcode::INVOKE_VIRTUAL, ("invoke-virtual", InstructionFormat::Format35c));
    map.insert(Opcode::INVOKE_SUPER, ("invoke-super", InstructionFormat::Format35c));
    map.insert(Opcode::INVOKE_DIRECT, ("invoke-direct", InstructionFormat::Format35c));
    map.insert(Opcode::INVOKE_STATIC, ("invoke-static", InstructionFormat::Format35c));
    map.insert(Opcode::INVOKE_INTERFACE, ("invoke-interface", InstructionFormat::Format35c));
    map.insert(Opcode::INVOKE_VIRTUAL_RANGE, ("invoke-virtual/range", InstructionFormat::Format3rc));
    map.insert(Opcode::INVOKE_SUPER_RANGE, ("invoke-super/range", InstructionFormat::Format3rc));
    map.insert(Opcode::INVOKE_DIRECT_RANGE, ("invoke-direct/range", InstructionFormat::Format3rc));
    map.insert(Opcode::INVOKE_STATIC_RANGE, ("invoke-static/range", InstructionFormat::Format3rc));
    map.insert(Opcode::INVOKE_INTERFACE_RANGE, ("invoke-interface/range", InstructionFormat::Format3rc));
...
pub fn disassemble_method(
    ...
    while pc < insns.len() {
        ...
        if pc + size_units > insns.len() {
             let formatted_line = format!("0x{:04x}: {} (Error: instruction truncated)", address, disassembly);
